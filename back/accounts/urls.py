...
from .views import SignupView, LoginView, LogoutView, MeView, NoticeListView, NoticeDetailView, GoogleCallbackView, GoogleLoginURLView, NaverLoginURLView, NaverCallbackView
